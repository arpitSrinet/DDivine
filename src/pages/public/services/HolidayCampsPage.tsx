 ...
 * @description Phase 4 stub for the holiday football camps service route.
...
const HolidayCampsPage = () => (
  <>
    <PageSEO
      description={SEO_META.holidayCamps.description}
      title={SEO_META.holidayCamps.title}
    />
    <Navbar />
    <PageWrapper>
      <SectionWrapper background="white">
        <h1 className="font-heading text-5xl uppercase tracking-wide text-primary">
          {SERVICES_COPY.pages.holidayCamps}
        </h1>
