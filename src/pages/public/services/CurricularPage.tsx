 ...
 * @description Phase 4 stub for the curricular activities service route.
...
const CurricularPage = () => (
  <>
    <PageSEO
      description={SEO_META.curricular.description}
      title={SEO_META.curricular.title}
    />
    <Navbar />
    <PageWrapper>
      <SectionWrapper background="white">
        <h1 className="font-heading text-5xl uppercase tracking-wide text-primary">
          {SERVICES_COPY.pages.curricular}
        </h1>
