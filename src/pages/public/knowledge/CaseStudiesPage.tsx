 ...
 * @description Phase 4 stub for the case studies route.
...
const CaseStudiesPage = () => (
  <>
    <PageSEO
      description={SEO_META.caseStudies.description}
      title={SEO_META.caseStudies.title}
    />
    <Navbar />
    <PageWrapper>
      <SectionWrapper background="white">
        <h1 className="font-heading text-5xl uppercase tracking-wide text-primary">
          {KNOWLEDGE_COPY.caseStudiesTitle}
        </h1>
